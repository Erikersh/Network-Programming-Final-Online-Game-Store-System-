...
這是一個非常貼心的提醒！預先建立好的測試資料 (Seed Data) 能讓助教在 Demo 時省去大量重複註冊與上架的時間，直接驗收核心功能。

請將以下內容新增到你的 **`README.md`** 中，建議放在 **「🚀 快速啟動」** 之後，或是獨立一個 **「🧪 Pre-loaded Testing Data (預設測試資料)」** 章節。
